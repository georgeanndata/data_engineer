...
path = "data/"
file_name = "small_insurance_claims.csv" #change to insurance_claims.csv or small_insurance_claims.csv for testing
...
def check_col_names(v, b, csv_col_name):
    ...
    ###col_name = [ext_char for ext_char in csv_col_name if any(xs in ext_char for xs in v)]      
    ###col_name = [ext_char for ext_char in csv_col_name if any(ext_char.startswith(bs) for bs in b)]      
    #print(col_name)
